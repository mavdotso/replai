                ...
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    ...
                    <div className="text-center pb-12 md:pb-16">
                        <h1 className="sm:text-8xl text-6xl font-bold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">
                            Grow on LinkedIn fast with <span className="bg-clip-text text-transparent bg-gradient-to-b from-zinc-500 to-zinc-950">Smart AI Assistant</span>
                        </h1>
                        <div className="max-w-3xl mx-auto">
                            <p className="sm:text-2xl text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">
                                Grow your professional network and save time with AI-powered extension made for networking.
                            </p>
